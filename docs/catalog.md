...
### k0.catalog.delete_servicetemplate
...
### k0.catalog.install_servicetemplate
...
When you call `k0.catalog.install_servicetemplate`, the server:
...
- **Uninstall Support**: Use `k0.catalog.delete_servicetemplate` to remove installed templates
...
- **Cache Warmup**: Perform an initial `k0.catalog.list` call on server startup to warm SQLite cache
